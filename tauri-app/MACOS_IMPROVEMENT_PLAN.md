...
- File > Active Project exposes native-menu Finder, editor, external terminal, POSIX path, `xolotl-code://` link, shell open-command, and context-prompt handoffs.
...
- Make project and file handoff frictionless:
  ...
  - Keep native-menu access for active project handoffs. Done for File > Active Project, including POSIX path and prompt-ready context blocks.
