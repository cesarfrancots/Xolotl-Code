...
|----|-------|--------|-----------|--------|-------------------|--------------------|
| 0.1 | Bench harness skeleton | TODO | — | `feat/p0-bench-harness` | `rust/crates/bench/**`, `runtime/src/bench.rs` (recorder trait, B1), recorder calls in `conversation.rs` + `tools/src/lib.rs` | — |
